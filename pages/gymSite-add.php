      ...
      <div class="card-body">
        <form onsubmit="sendData(event)">
          ...
          <div class="row mb-6">
            ...
            <div class="col-sm-10">
              <textarea id="basic-default-address" class="form-control" placeholder="請輸入地址" aria-describedby="basic-icon-default-message2" rows="2" name="address" ></textarea>
          ...
          <div class="row mb-6">
            ...
            <div class="form-check form-check-inline mt-3">
              <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="Monday" name="business_days[]" checked>
              <label class="form-check-label" for="inlineCheckbox1">Monday</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="Tuesday" name="business_days[]" checked>
          ...
          <div class="row mb-6">
            ...
            <div class="col-sm-10">
              <input type="time" class="form-control " id="basic-default-open" name="open" value="12:30:00" require>
            </div>
          </div>
          <div class="row mb-6">
            <label class="col-sm-2 col-form-label" for="basic-default-colse">關門時間</label>
            <div class="col-sm-10">
              <input type="time" class="form-control " id="basic-default-colse" name="colse" value="12:30:00" require>
            </div>
          </div>
          <div class="row mb-6">
            <label class="col-sm-2 col-form-label" for="basic-default-description">描述</label>
            <div class="col-sm-10">
              <textarea id="basic-default-description" class="form-control" placeholder="description..." aria-describedby="basic-icon-default-message2" rows="5" name="description" ></textarea>
          ...
          <div class="row mb-6">
            ...
            <div class="col-sm-10">
              <input type="tel" class="form-control " id="basic-default-tel" name="tel" placeholder="06-5800000"  require>
            </div>
          </div>
          <div class="row mb-6">
