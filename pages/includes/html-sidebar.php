...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Person & Site</span>
    </li>
    ...
    <li class="menu-item <?= in_array($pageName, ['gymSite', 'gymSite-add', 'gymSite-edit']) ? 'active' : '' ?>">
      <a href="gymSite.php" target="_blank" class="menu-link  menu-toggle">
        <i class="menu-icon fa-solid fa-location-dot fa-2xs"></i>
        <div class="text-truncate" data-i18n="Support">GYM點列表</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="gymSite-add.php" class="menu-link">
            <div class="text-truncate" data-i18n="Analytics">新增GYM點</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="gymSite-edit.php" class="menu-link">
            <div class="text-truncate" data-i18n="Analytics">編輯GYM點</div>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="menu-item <?= in_array($pageName, ['article', 'article-add', 'article-edit']) ? 'active' : '' ?>">
      <a href="article.php" target="_blank" class="menu-link  menu-toggle">
    ...
    <li class="menu-item <?= in_array($pageName, ['videos', 'videos-add', 'videos-edit']) ? 'active' : '' ?>">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="videos-edit.php" class="menu-link">
