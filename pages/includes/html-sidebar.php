...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">Gym管系統</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">我們從這裡開始</span>
    </li>
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">人員相關</span>
    </li>
    <li class="menu-item">
      <a href="https://github.com/themeselection/sneat-html-admin-template-free/issues" target="_blank" class="menu-link">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">其他</span>
    </li>
    <li class="menu-item">
      <a href="https://github.com/themeselection/sneat-html-admin-template-free/issues" target="_blank" class="menu-link">
    ...
    <li class="menu-item <?= $pageName == 'article' ? 'active' : '' ?>">
      <a href="article.php" target="_blank" class="menu-link">
        <i class="menu-icon tf-icons bx bx-file"></i>
        <div class="text-truncate" data-i18n="Support">文章管理</div>
      </a>
    </li>
    <li class="menu-item <?=$pageName=='gymNews'?'active':'' ?>">
    ...
    <li class="menu-item">
      <a href="https://github.com/themeselection/sneat-html-admin-template-free/issues" target="_blank" class="menu-link">
        ...
        <div class="text-truncate" data-i18n="Support">預約列表</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="https://github.com/themeselection/sneat-html-admin-template-free/issues" target="_blank" class="menu-link">
    ...
    <li class="menu-item <?=$pageName=='gymSite'?'active':'' ?>">
      <a href="gymSite.php" target="_blank" class="menu-link ">
        <i class="menu-icon fa-solid fa-location-dot fa-2xs"></i>
        <div class="text-truncate" data-i18n="Support">GYM點列表</div>
      </a>
    </li>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div class="text-truncate" data-i18n="Dashboards">首頁</div>
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/app-logistics-dashboard.html" target="_blank" class="menu-link">
